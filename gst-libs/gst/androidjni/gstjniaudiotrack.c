    ...
    gint buffer_size, gint audio_session_id)
{
  ...
  GST_DEBUG ("Creating new track %d %d %d %d %d", rate, channels, width,
  ...
  (*env)->CallObjectMethod (env, audio_attr_builder_obj,
  ...
  audio_attr_obj = (*env)->CallObjectMethod (env, audio_attr_builder_obj,
  ...
  (*env)->CallObjectMethod (env, audio_format_builder_obj,
  ...
  audio_format_obj = (*env)->CallObjectMethod (env, audio_format_builder_obj,
...
gst_jni_audio_track_flush (GstJniAudioTrack * self)
{
  ...
  env = gst_jni_get_env ();
  (*env)->CallVoidMethod (env, self->jobject, audio_track.flush);
}
...
gst_jni_audio_track_get_play_state (GstJniAudioTrack * self)
{
  ...
  env = gst_jni_get_env ();
  return (GstAudioTrackPlayState) (*env)->CallIntMethod (env,
...
gst_jni_audio_track_get_playback_head_position (GstJniAudioTrack * self)
{
  ...
  env = gst_jni_get_env ();
  return (gint) (*env)->CallIntMethod (env,
...
gst_jni_audio_track_stop (GstJniAudioTrack * self)
{
  ...
  env = gst_jni_get_env ();
  (*env)->CallVoidMethod (env, self->jobject, audio_track.stop);
}
...
gst_jni_audio_track_pause (GstJniAudioTrack * self)
{
  ...
  env = gst_jni_get_env ();
  (*env)->CallVoidMethod (env, self->jobject, audio_track.pause);
}
...
gst_jni_audio_track_play (GstJniAudioTrack * self)
{
  ...
  env = gst_jni_get_env ();
  (*env)->CallVoidMethod (env, self->jobject, audio_track.play);
}
    ...
    gfloat pitch)
{
  ...
  (*env)->CallObjectMethod (env, playback_params_obj, playback_params.set_speed,
      speed);
  (*env)->CallObjectMethod (env, playback_params_obj, playback_params.set_pitch,
      pitch);
  (*env)->CallVoidMethod (env, self->jobject, audio_track.set_playback_params,
      playback_params_obj);
  J_DELETE_LOCAL_REF (playback_params_obj);
}
...
gst_jni_audio_track_set_volume (GstJniAudioTrack * self, gfloat volume)
{
  ...
  env = gst_jni_get_env ();
  (*env)->CallVoidMethod (env, self->jobject, audio_track.set_volume, volume);
}
...
gst_jni_audio_track_write (GstJniAudioTrack * self, GstBuffer * buf)
{
  ...
  j_buffer = (*env)->NewDirectByteBuffer (env, GST_BUFFER_DATA (buf),
      GST_BUFFER_SIZE (buf));
  ret =
      (GstAudioTrackError) (*env)->CallIntMethod (env, self->jobject,
      audio_track.write_buffer, j_buffer, GST_BUFFER_SIZE (buf),
      AUDIO_TRACK_WRITE_BLOCKING);
  J_DELETE_LOCAL_REF (j_buffer);
