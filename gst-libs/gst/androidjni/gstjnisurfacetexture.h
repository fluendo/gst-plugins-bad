...
void gst_jni_surface_texture_set_default_buffer_size (GstJniSurfaceTexture *
    texture, gint width, gint height);

void gst_jni_surface_texture_update_tex_image (GstJniSurfaceTexture * texture);

void gst_jni_surface_texture_detach_from_gl_context (GstJniSurfaceTexture *
    texture);

void gst_jni_surface_texture_attach_to_gl_context (GstJniSurfaceTexture *
    texture, gint index);

void gst_jni_surface_texture_get_transform_matrix (GstJniSurfaceTexture *
    texture, gfloat * matrix);
