...
jmethodID
gst_jni_get_method (JNIEnv * env, jclass klass, const gchar * name,
...
jmethodID
gst_jni_get_static_method (JNIEnv * env, jclass klass, const gchar * name,
    const gchar * signature)
{
  jmethodID ret;
...
jfieldID
gst_jni_get_field_id (JNIEnv * env, jclass klass, const gchar * name,
    const gchar * type)
{
  jfieldID ret;
...
jobject
gst_jni_new_object (JNIEnv * env, jclass klass, jmethodID constructor, ...)
{
  jobject tmp;
  va_list args;
  ...
  return gst_jni_object_make_global (env, tmp);
}

jobject
gst_jni_new_object_from_static (JNIEnv * env, jclass klass,
    jmethodID method, ...)
{
  jobject tmp;
  va_list args;
...
jobject
gst_jni_object_make_global (JNIEnv * env, jobject object)
{
  jobject ret;
  ...
  if (!ret) {
    ...
    gst_jni_object_local_unref (env, object);
  }
  return ret;
}

jobject
gst_jni_object_ref (JNIEnv * env, jobject object)
{
  jobject ret;
...
void
gst_jni_object_unref (JNIEnv * env, jobject object)
{
  (*env)->DeleteGlobalRef (env, object);
}

void
gst_jni_object_local_unref (JNIEnv * env, jobject object)
{
  (*env)->DeleteLocalRef (env, object);
}

jstring
gst_jni_string_from_gchar (JNIEnv * env, const gchar * string)
{
  return (*env)->NewStringUTF (env, string);
}

gchar *
gst_jni_string_to_gchar (JNIEnv * env, jstring string, gboolean release)
{
  const gchar *s = NULL;
  gchar *ret = NULL;
...
gboolean
gst_jni_call_void_method (JNIEnv * env, jobject obj, jmethodID methodID, ...)
{
  gboolean ret = TRUE;
  va_list args;
  va_start (args, methodID);
...
static JNIEnv *
gst_jni_attach_current_thread (void)
{
  JNIEnv *env;
...
static void
gst_jni_detach_current_thread (void *env)
{
...
static gboolean
gst_jni_initialize_java_vm (void)
{
  jsize n_vms;
...
JNIEnv *
gst_jni_get_env (void)
{
  JNIEnv *env;

  if ((env = pthread_getspecific (__current_jni_env)) == NULL) {
    env = gst_jni_attach_current_thread ();
