...
#ifndef _AMC_GST_VIDEO_DECODER_H_
#define _AMC_GST_VIDEO_DECODER_H_

#include <gst/base/gstadapter.h>

#include <video/gstvideoutils.h>
...
struct _GstVideoDecoderClass
{
  ...
  gboolean      (*stop)           (GstVideoDecoder *decoder, gboolean wait_for_buffers);
...
void gst_video_decoder_release_frame (GstVideoDecoder * dec, GstVideoCodecFrame * frame);
